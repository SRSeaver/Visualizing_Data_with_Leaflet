...
function createFeatures (earthquakeData) {
	...
	function onEachFeature(feature, layer) {
		layer.bindPopup("<h1>Location: " + feature.properties.place + "</h1><hr><p>Magnitude: " + feature.properties.mag + "</p><hr><p>" + new Date (feature.properties.time) + "</p>");
	}
...
function createMap(earthquakes) {
  ...
  // Create function to match the colors to magnitude
  function getColor(d) {
